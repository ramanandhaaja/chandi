...
const Photo = () => {
  ...
  return (
    <section className="py-20 px-6 md:px-12 lg:px-24 bg-[#F7F4ED]">
            ...
            <div className="grid grid-cols-3 gap-6 ">
              {images.map((image, idx) => (
                <div key={idx} className=" cursor-pointer">
                  <div className="relative rounded-2xl overflow-hidden md:h-[151px] md:w-[248px] w-full hover:scale-110 transition-all ">
                    <Image
                      src={image.src}
                      alt={image.alt}
                      fill
