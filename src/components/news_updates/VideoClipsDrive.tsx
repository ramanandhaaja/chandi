...
const VideoClipsDrive: React.FC<Props> = ({ content = [], folderId, parentFolderId }) => {
      ...
      <div className=" mx-auto w-full max-w-[1500px] flex flex-col md:flex-row gap-8 md:gap-18 lg:gap-20 pt-8 px-4 md:px-8 lg:px-12 xl:px-16 py-12 lg:py-16">
        ...
        <div className="md:w-3/4 w-full ">
          ...
          {(folderId || parentFolderId) && (
            <div className="mb-4">
              {loading && <p className="text-white/80 text-sm">Loading videos...</p>}
              {error && (
          ...
          {items.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-[50vh] text-center">
              <p className="text-white/80 text-lg mb-2">No videos available</p>
...
export default VideoClipsDrive;
